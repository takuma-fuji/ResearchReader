...
def regenerate_question(user_input):
    ...
    prompt = ChatPromptTemplate.from_template(
        """
        次の会話履歴とフォローアップの質問を参考にして、フォローアップの質問が他の情報なしでも理解できるように、独立した質問として言い換えてください。
        ...
        以下の条件に従って独立した質問を作成してください:
        - フォローアップの質問が独立して理解できるよう、必要に応じて会話の履歴から関連する情報を取り込みます。
        - 文意が明確で、会話履歴の内容が含まれていなくてもフォローアップの質問の意図が伝わるようにしてください。
